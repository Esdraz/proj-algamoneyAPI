...
* The original package name 'com.esdraz.algamoney-api.algamoney-api' is invalid and this project uses 'com.esdraz.algamoneyapi.algamoneyapi' instead.
...
* [Flyway Migration](https://docs.spring.io/spring-boot/docs/2.6.10/reference/htmlsingle/#howto.data-initialization.migration-tool.flyway)
